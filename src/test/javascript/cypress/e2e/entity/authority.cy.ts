...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '8f747cfc-f59b-4ecc-bec7-2d6c4abca1a6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('10420586-35e7-4892-b8ee-39abd5fd3560');
      cy.get(`[data-cy="name"]`).should('have.value', '10420586-35e7-4892-b8ee-39abd5fd3560');
