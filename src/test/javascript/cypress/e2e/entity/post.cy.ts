...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'huzzah portend', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-24T15:14:41.892Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('an pith project');
      cy.get(`[data-cy="title"]`).should('have.value', 'an pith project');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-24T11:47');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-24T11:47');
