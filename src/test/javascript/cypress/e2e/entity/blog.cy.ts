...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'hmph save', handle: 'adviser' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('incompatible impassioned');
      cy.get(`[data-cy="name"]`).should('have.value', 'incompatible impassioned');

      cy.get(`[data-cy="handle"]`).type('low vigilant jovial');
      cy.get(`[data-cy="handle"]`).should('have.value', 'low vigilant jovial');
