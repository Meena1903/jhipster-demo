...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 22637 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 29553 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 18651 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 3619 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 20338 };
      post.blog = blog;
      const tag: ITag = { id: 2588 };
      post.tags = [tag];
